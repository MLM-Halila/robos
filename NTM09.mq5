...
sinput string Versão ="M09 4p BTC M15";                  //
input double FAKESALDO = 0; //Saldo teste
input int METOD_1                 = 2;           //Metodo
input int METOD_2                 = 4;           //Metodo
...
input double F_MAX_LOTE = .09;          //%  Lote maximo para operar
input double F_DIA_MAX_USD_GAIN = 10;  //% Max  DIA GAIN (Fecha dia)
input double F_DIA_MAX_USD_LOSS = 20;  //% Max DIA LOSS (Fecha dia)
input double F_CUR_MAX_USD_GAIN = 10;  //% OP Max SALDO GAIN
input double F_CUR_MAX_USD_LOSS = 5;  //% OP Max SALDO LOSS
