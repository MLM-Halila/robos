...
sinput string Versão ="M12 1.9";                  //
input bool PROP = true;
...
input double I_SL_size  =           100;            //   Tamanho maximo do LOSS (USD)
...
input double I_DIA_MAX_USD_LOSS  =          25;            //   Max USD DIA LOSS (Fecha dia)
               ...
               if(NWOP == 0)
                 {
                  ...
                  //                  Print("DirOP ",NWOP," DMP ",DMP," DMM ",DMM," DMG ",DMG," PDR ",PDR);
                  if(NWOP >0)
                    {
                     //Print("NWOP ",NWOP," ===");
                    }
